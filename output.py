...
with open("output.txt", "w") as file:
    ...
    file.write(str(coinbase_data) + "\n")
    coinbase_txid_little_endian = bytes.fromhex(hash256(coinbase_data))[::-1].hex()
    file.write(coinbase_txid_little_endian + "\n")
    for txid in tx_list:
